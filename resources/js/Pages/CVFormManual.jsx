...
<table class="data-table" style="margin-top:6px;"><thead><tr><th>OTHER SKILLS / DİĞER</th></tr></thead><tbody><tr><td>${otherSkillsText}</td></tr></tbody></table>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100" style={{ fontFamily: "'Poppins', sans-serif" }}>
                                ...
                                {formData.workExperiences.map((work, idx) => (
                                    <div key={idx} className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        <input
                                            type="text"
                                            value={work.employer}
                                            onChange={(e) => handleArrayChange('workExperiences', idx, 'employer', e.target.value)}
                                            className="form-input"
                                        ...
                                        <input
                                            type="text"
                                            value={work.position}
                                            onChange={(e) => handleArrayChange('workExperiences', idx, 'position', e.target.value)}
                                            className="form-input"
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleArrayChange('workExperiences', idx, 'start_date', e.target.value)}
                                            className="form-input"
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleArrayChange('workExperiences', idx, 'leaving_date', e.target.value)}
                                            className="form-input"
                                ...
                                {formData.educations.map((edu, idx) => (
                                    <div key={idx} className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        <input
                                            type="text"
                                            value={edu.school}
                                            onChange={(e) => handleArrayChange('educations', idx, 'school', e.target.value)}
                                            className="form-input"
                                        ...
                                        <input
                                            type="text"
                                            value={edu.study}
                                            onChange={(e) => handleArrayChange('educations', idx, 'study', e.target.value)}
                                            className="form-input"
                                            placeholder="Study"
                                        />
                                        <input
                                            ...
                                            onChange={(e) => handleArrayChange('educations', idx, 'start_date', e.target.value)}
                                            className="form-input"
                                            placeholder="Starting Date"
                                        />
                                        <input
                                            ...
                                            onChange={(e) => handleArrayChange('educations', idx, 'graduation_date', e.target.value)}
                                            className="form-input"
                                ...
                                {formData.languages.map((lang, idx) => (
                                    <div key={idx} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <input
                                            type="text"
                                            value={lang.name}
                                            onChange={(e) => handleArrayChange('languages', idx, 'name', e.target.value)}
                                            className="form-input"
                                ...
                                {formData.pcSkills.map((skill, idx) => (
                                    <div key={idx} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <input
                                            type="text"
                                            value={skill.name}
                                            onChange={(e) => handleArrayChange('pcSkills', idx, 'name', e.target.value)}
                                            className="form-input"
                                            placeholder="MS Word"
                                        />
                                        <select
                                            value={skill.level}
                                            onChange={(e) => handleArrayChange('pcSkills', idx, 'level', e.target.value)}
                                            className="form-input"
                                        >
                                            <option value="">Beginner</option>
                                            <option value="Beginner">Beginner</option>
            ...
            {currentStep === 4 && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50" style={{ display: 'none' }} id="generateModal">
                    <div className="bg-white rounded-2xl p-8 max-w-md w-full animate-scale-in">
                        <h3 className="text-2xl font-bold mb-6 text-center">Generate CV</h3>
                        <div className="space-y-4">
                            <button onClick={previewCV} className="w-full py-4 bg-gray-100 border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-200 transition font-semibold flex items-center justify-center gap-2">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                </svg>
                            ...
                            <button onClick={downloadPDF} disabled={isGenerating} className="w-full btn-primary py-4 text-white rounded-lg font-semibold flex items-center justify-center gap-2 disabled:opacity-50">
                                {isGenerating ? (
                                    <>
                            ...
                            <button onClick={downloadHTML} className="w-full py-4 bg-green-500 text-white rounded-lg hover:bg-green-600 transition font-semibold flex items-center justify-center gap-2">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
